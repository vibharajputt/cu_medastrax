  ...
  const handle2FAVerify = () => {
    ...
    setTimeout(() => {
      if (code === '123412') {
        ...
        toast.error('Invalid 2FA code. Use 123412 for demo.');
      }
  ...
  const googleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      try {
        ...
        const response = await authAPI.googleLogin(profile.email, profile.name, profile.picture);

        login(response.data);
        localStorage.setItem('user_type', selectedRole);
        toast.success(`Welcome, ${response.data.name}! 🎉`, { id: loadingToast, duration: 3000 });
    ...
    <div className="auth-page">
      ...
      >
        ...
        <div className="demo-credentials">
          ...
          <p className="demo-hint">Password: <code>password123</code> &nbsp;|&nbsp; 2FA code: <code>123412</code></p>
        </div>
      </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="twofa-subtitle">
                ...
                <span style={{ color: 'var(--primary)', fontWeight: 600 }}>Demo code: 123412</span>
              </p>
              ...
              {otpError && (
                <p className="otp-error-msg">❌ Invalid code. Hint: use <strong>123412</strong></p>
              )}
              ...
              <p className="twofa-resend">
                ...
                <button
                  ...
                  onClick={() => toast.success('Code resent! (Demo — use 123412)')}
                >
                  Resend code
                </button>
              </p>
